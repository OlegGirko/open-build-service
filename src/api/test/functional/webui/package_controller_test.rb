...
class Webui::PackageControllerTest < Webui::IntegrationTest
  ...
  def test_succesful_comment_creation
    use_js
    login_Iggy
    visit File.join(root_path, 'package/show/home:Iggy/TestPack')
  ...
  def test_another_succesful_comment_creation
    use_js
    login_Iggy
    visit File.join(root_path, 'package/show?project=home:Iggy&package=TestPack')
  ...
  def test_succesful_reply_comment_creation
    use_js
    login_Iggy
    visit File.join(root_path, 'package/show/BaseDistro3/pack2')
